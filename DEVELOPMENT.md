...
the coverage delta. The badge stays blank until that workflow has run on `main`.
...
|----------|---------|-------------|
| `test.yaml` | Push/PR to any branch | Runs tests on Python 3.10 + 3.12, and reports coverage from the 3.12 leg |
